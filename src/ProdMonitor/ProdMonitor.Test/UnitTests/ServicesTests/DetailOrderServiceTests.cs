...
namespace ProdMonitor.Test.UnitTests
{
    public class DetailOrderServiceTests
    {
        ...
        public async Task CreateDetailOrderAsync_Should_Throw_Exception_If_Detail_Not_Found()
        {
            ...
            // Act & Assert
            var exception = await Assert.ThrowsAsync<DetailNotFoundException>(() => _detailOrderService.CreateDetailOrderAsync(orderCreate));
        }
        ...
        public async Task CreateDetailOrderAsync_Should_Throw_Exception_If_Order_Has_No_Details()
        {
            ...
            // Act & Assert
            var exception = await Assert.ThrowsAsync<ArgumentException>(() => _detailOrderService.CreateDetailOrderAsync(orderCreate));
        }
        ...
        public async Task GetDetailOrderById_Should_Throw_DetailOrderNotFoundException_If_Order_Not_Found()
        {
            ...
            // Act & Assert
            var exception = await Assert.ThrowsAsync<DetailOrderNotFoundException>(() => _detailOrderService.GetDetailOrderById(orderId));
