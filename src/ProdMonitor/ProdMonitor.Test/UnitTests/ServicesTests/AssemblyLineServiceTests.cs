...
namespace ProdMonitor.Test.UnitTests
{
    public class AssemblyLineServiceTests
    {
        ...
        public AssemblyLineServiceTests()
        {
            ...
            _assemblyLineService = new AssemblyLineService(_mockAssemblyLineRepository.Object, _mockLogger.Object);
        }
        ...
        public async Task GetAssemblyLineByIdAsync_LineNotFound_ThrowsLineNotFoundException()
        {
            ...
            // Act & Assert
            var exception = await Assert.ThrowsAsync<LineNotFoundException>(
                () => _assemblyLineService.GetAssemblyLineByIdAsync(lineId));
        }
